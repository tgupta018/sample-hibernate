...
@Table(name = "PRODUCT_IMAGES", schema = "FOD", catalog = "")
public class ProductImagesEntity {
    ...
    private ProductImagesEntity productImagesByDetailImageId;
    private Collection<ProductImagesEntity> productImagesByProductImageId;

    @Id
    @Column(name = "PRODUCT_IMAGE_ID", nullable = false, precision = 0)
    ...
    @Basic
    @Column(name = "DETAIL_IMAGE_ID", nullable = true, precision = 0)
    ...
    @ManyToOne
    @JoinColumn(name = "DETAIL_IMAGE_ID", referencedColumnName = "PRODUCT_IMAGE_ID", table = "PRODUCT_IMAGES")
    public ProductImagesEntity getProductImagesByDetailImageId() {
        return productImagesByDetailImageId;
    }

    public void setProductImagesByDetailImageId(ProductImagesEntity productImagesByDetailImageId) {
        this.productImagesByDetailImageId = productImagesByDetailImageId;
    }

    @OneToMany(mappedBy = "productImagesByDetailImageId")
    public Collection<ProductImagesEntity> getProductImagesByProductImageId() {
        return productImagesByProductImageId;
    }

    public void setProductImagesByProductImageId(Collection<ProductImagesEntity> productImagesByProductImageId) {
