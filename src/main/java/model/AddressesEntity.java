...
@javax.persistence.Table(name = "ADDRESSES", schema = "FOD", catalog = "")
public class AddressesEntity {
    private Long addressId;

    @Id
    @javax.persistence.Column(name = "ADDRESS_ID", nullable = false, precision = 0)
    ...
    @Basic
    @javax.persistence.Column(name = "ADDRESS1", nullable = false, length = 40)
    ...
    @Basic
    @javax.persistence.Column(name = "ADDRESS2", nullable = true, length = 40)
    ...
    @Basic
    @javax.persistence.Column(name = "CITY", nullable = false, length = 40)
    ...
    @Basic
    @javax.persistence.Column(name = "POSTAL_CODE", nullable = true, length = 12)
    ...
    @Basic
    @javax.persistence.Column(name = "STATE_PROVINCE", nullable = false, length = 40)
    ...
    @Basic
    @javax.persistence.Column(name = "COUNTRY_ID", nullable = false, length = 2)
    ...
    @Basic
    @javax.persistence.Column(name = "LONGITUDE", nullable = true, precision = 0)
    ...
    @Basic
    @javax.persistence.Column(name = "LATITUDE", nullable = true, precision = 0)
