...
@javax.persistence.Table(name = "ADDRESS_USAGES", schema = "FOD", catalog = "")
public class AddressUsagesEntity {
    private Long addressUsagesId;

    @Id
    @javax.persistence.Column(name = "ADDRESS_USAGES_ID", nullable = false, precision = 0)
    ...
    @Basic
    @javax.persistence.Column(name = "ASSOCIATED_OWNER_ID", nullable = false, precision = 0)
    ...
    @Basic
    @javax.persistence.Column(name = "OWNER_TYPE_CODE", nullable = false, length = 30)
    ...
    @Basic
    @javax.persistence.Column(name = "USAGE_TYPE_CODE", nullable = false, length = 30)
    ...
    @Basic
    @javax.persistence.Column(name = "EXPIRED_FLAG", nullable = false, length = 1)
